...
import {
  resolveShadoRuntimeLightBehavior,
  shadoRuntimeLightScheduleLevel,
  wrapShadoHour,
  type ShadoRuntimeLightBehavior,
} from '../world/light-behavior';

type RuntimeLightBehavior = ShadoRuntimeLightBehavior;
const resolveRuntimeLightBehavior = resolveShadoRuntimeLightBehavior;
const scheduleLevel = shadoRuntimeLightScheduleLevel;
const wrapHour = wrapShadoHour;
